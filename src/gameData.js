...
// mais une voyelle (A, E, I, O, U, Y) peut être jouée jusqu'à VOWEL_USES fois avant
// de quitter la main, alors qu'une consonne ne peut servir qu'une seule fois.
const ALPHABET = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'.split('')
export const VOWELS = ['A', 'E', 'I', 'O', 'U', 'Y']
export const VOWEL_USES = 3

export function buildAlphabetHand() {
  return ALPHABET.map((letter) => ({
    id: `l${letter}${Math.random().toString(36).slice(2, 6)}`,
    syllable: letter,
    usesLeft: VOWELS.includes(letter) ? VOWEL_USES : 1,
  }))
}
...
const CACHE_KEY = 'syllabo_fr_trie_wordlist_v2'
